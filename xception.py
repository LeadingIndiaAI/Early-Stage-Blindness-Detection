...
model = keras.applications.xception.Xception(include_top=False, weights='xception_weights_tf_dim_ordering_tf_kernels_notop.h5',input_shape=input_shape,pooling='avg',classes=5)
...
filepath="xception_model.hdf5" # checkpoint
...
model.save('end_xception_model.hdf5')
