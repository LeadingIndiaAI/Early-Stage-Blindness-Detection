...
model =keras.applications.densenet.DenseNet169(include_top=False, weights='densenet169_weights_tf_dim_ordering_tf_kernels_notop.h5', input_shape=input_shape, pooling='avg')
...
filepath="dense_model.hdf5" # checkpoint
...
model.save('end_dense_model.hdf5')
'''

model=load_model('dense_model.hdf5')
